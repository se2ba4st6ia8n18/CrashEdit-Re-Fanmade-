...
namespace CrashEdit.CE
{
    public partial class ErrorReporter : DarkForm
    {
        ...
        public ErrorReporter(IWin32Window owner)
        {
            ...
            lblTitle.Text = Properties.EventHandler.ErrorReporter_Title;
            optAbort.Text = Properties.EventHandler.ErrorReporter_Abort;
            optSkip.Text = Properties.EventHandler.ErrorReporter_Skip;
            optIgnore.Text = Properties.EventHandler.ErrorReporter_Ignore;
            optIgnoreAll.Text = Properties.EventHandler.ErrorReporter_IgnoreAll;
            optBreak.Text = Properties.EventHandler.ErrorReporter_Break;
        }
