...
namespace CrashEdit.CE
{
    ...
    public abstract class GLViewer : GLControl
    {
        ...
        {
            public static readonly ControlsKeyboardInfo ResetCamera = new(Keys.R, Properties.EventHandler.ViewerControls_ResetCamera);
            public static readonly ControlsKeyboardInfo ToggleTextures = new(Keys.T, Properties.EventHandler.ViewerControls_ToggleTextures);
            public static readonly ControlsKeyboardInfo ToggleZoneOctree = new(Keys.X, Properties.EventHandler.ViewerControls_ToggleZoneOctree);
            public static readonly ControlsKeyboardInfo ToggleZoneOctreeOutline = new(Keys.V, Properties.EventHandler.ViewerControls_ToggleZoneOctreeOutline);
            public static readonly ControlsKeyboardInfo ToggleZoneOctreeNeighbors = new(Keys.F, Properties.EventHandler.ViewerControls_ToggleZoneOctreeNeighbors);
            public static readonly ControlsKeyboardInfo OpenOctreeWindow = new(Keys.C, Properties.EventHandler.ViewerControls_OpenOctreeWindow);
            public static readonly ControlsKeyboardInfo ToggleZoneOctreeFlip = new(Keys.M, Properties.EventHandler.ViewerControls_ToggleZoneOctreeFlip);
            public static readonly ControlsKeyboardInfo ToggleTimeTrial = new(Keys.Y, Properties.EventHandler.ViewerControls_ToggleTimeTrial);
            public static readonly ControlsKeyboardInfo ToggleCollisionAnim = new(Keys.C, Properties.EventHandler.ViewerControls_ToggleCollisionAnim);
            public static readonly ControlsKeyboardInfo ToggleLerp = new(Keys.I, Properties.EventHandler.ViewerControls_ToggleLerp);
            public static readonly ControlsKeyboardInfo ToggleNormals = new(Keys.N, Properties.EventHandler.ViewerControls_ToggleNormals);
            public static readonly ControlsKeyboardInfo ChangeCullMode = new(Keys.U, Properties.EventHandler.ViewerControls_ChangeCullMode);
            public static readonly ControlsKeyboardInfo ToggleHelp = new(Keys.H, Properties.EventHandler.ViewerControls_ToggleHelp);
            public static readonly ControlsKeyboardInfo EnterZoneAnchor = new(Keys.P, Properties.EventHandler.ViewerControls_EnterZoneAnchor);
            public static readonly ControlsKeyboardInfo ExitZoneAnchor = new(Keys.P, Properties.EventHandler.ViewerControls_ExitZoneAnchor);
            public static readonly ControlsKeyboardInfo ZoneAnchorPrevCam = new(Keys.Left, Properties.EventHandler.ViewerControls_ZoneAnchorPrevCam);
            public static readonly ControlsKeyboardInfo ZoneAnchorNextCam = new(Keys.Right, Properties.EventHandler.ViewerControls_ZoneAnchorNextCam);
            public static readonly ControlsKeyboardInfo ZoneAnchorSortList = new(Keys.L, Properties.EventHandler.ViewerControls_ZoneAnchorSortList);
            public static readonly ControlsKeyboardInfo ZoneAnchorDetach = new(Keys.K, Properties.EventHandler.ViewerControls_ZoneAnchorDetach);
            public static readonly ControlsKeyboardInfo ToggleSlowAnim = new(Keys.O, Properties.EventHandler.ViewerControls_ToggleSlowAnim);
            public static readonly ControlsKeyboardInfo ToggleModelCycle = new(Keys.Y, Properties.EventHandler.ViewerControls_ToggleModelCycle);
            public static readonly ControlsKeyboardInfo ToggleAlignedMovement = new(Keys.Z, Properties.EventHandler.ViewerControls_MoveAligned);
            public static readonly ControlsKeyboardInfo ToggleEntityVisual = new(Keys.G, Properties.EventHandler.ViewerControls_ToggleEntityVisual);
            public static readonly ControlsKeyboardInfo ToggleVerticesVisible = new(Keys.B, Properties.EventHandler.ViewerControls_ToggleVerticesVisible);
            public static readonly ControlsKeyboardInfo ToggleAnimation = new(Keys.Space, Properties.EventHandler.ViewerControls_ToggleAnimation);
        }
        #endregion
        ...
        protected virtual void PrintHelp()
        {
            if (CanMove())
            {
                con_help += Properties.EventHandler.ViewerControls_Move + '\n';
                con_help += Properties.EventHandler.ViewerControls_FastMove + '\n';
            }
            if (CanAim() && CanZoom())
                con_help += Properties.EventHandler.ViewerControls_AimAndZoom + '\n';
            else if (CanAim())
                con_help += Properties.EventHandler.ViewerControls_Aim + '\n';
            else if (CanZoom())
                con_help += Properties.EventHandler.ViewerControls_Zoom + '\n';
