...
namespace CrashEdit.CE
{
    ...
    public sealed class ProtoSceneryEntryController : EntryController
    {
        ...
        {
            if (DarkMessageBox.ShowWarning(Properties.EventHandler.Scenery_ExportOBJ, Properties.EventHandler.Scenery_ExportOBJ_Title, DarkDialogButton.YesNo) != DialogResult.Yes)
            {
                return;
            }
        ...
        {
            if (DarkMessageBox.ShowWarning(Properties.EventHandler.Scenery_ExportCOLLADA, Properties.EventHandler.Scenery_ExportCOLLADA_Title, DarkDialogButton.YesNo) != DialogResult.Yes)
            {
                return;
            }
